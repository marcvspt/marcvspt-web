...
![Elegir el provider donde tengamos el proyecto](/img/blog/infraestructura/astro-dokploy/dokploy-provider.png)

![Elegir el Build Type de Railpack](/img/blog/infraestructura/astro-dokploy/dokploy-build-type.png)
...
![Instalación de adaptador de nodejs](/img/blog/infraestructura/astro-dokploy/adaptador-nodejs.png)
...
![Script en package.json para que funcione el adaptador de Node.js](/img/blog/infraestructura/astro-dokploy/script-start.png)
...
![Host sobre los que se publicará la aplicación de Astro](/img/blog/infraestructura/astro-dokploy/host-publicacion-dokploy-env.png)
...
![alt text](/img/blog/infraestructura/astro-dokploy/host-publicacion-astro.png)
...
![Puerto por defecto de Dokploy configurado en las variables de entorno para forzar a Astro SSR a usarlo](/img/blog/infraestructura/astro-dokploy/puerto-dokploy-env-ssr.png)
...
![Puerto por de Astro cambiado al de Dokploy en astro.config.mjs](/img/blog/infraestructura/astro-dokploy/puerto-defecto-astro.png)
...
![Puerto por defecto de Dokploy cambiado al que usa Astro SSR](/img/blog/infraestructura/astro-dokploy/puerto-defecto-dokploy-ssr.png)

4. Iniciar la build y el despliegue

Ya con las configuraciones realizadas, procedemos al despliegue del aplicativo:

![Desplegar el proyecto Astro SSR y realizar la build](/img/blog/infraestructura/astro-dokploy/dokploy-deploy-build-ssr.png)

Listo, ya tenemos nuestro proyecto de **Astro** desplegado en nuestra plataforma de **Dokploy**.

![Aplicativo de Astro desplegado con SSR](/img/blog/infraestructura/astro-dokploy/astro-ssr-desplegado.png)
...
![Configuración de output static opcional](/img/blog/infraestructura/astro-dokploy/astro-static.png)
...
![Puerto por defecto de Dokploy configurado en las variables de entorno para forzar a Astro SSG a usarlo](/img/blog/infraestructura/astro-dokploy/puerto-dokploy-env-ssg.png)
...
![Desplegar el proyecto Astro SSG y realizar la build ](/img/blog/infraestructura/astro-dokploy/dokploy-deploy-build-ssg.png)

Listo, ya tenemos nuestro proyecto de **Astro** desplegado en nuestro **Dokploy**

![Aplicativo de Astro desplegado con SSG](/img/blog/infraestructura/astro-dokploy/astro-ssg-desplegado.png)
